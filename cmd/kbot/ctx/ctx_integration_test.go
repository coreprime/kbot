...
func TestResolveVFSPathPicksUpActiveContext(t *testing.T) {
	...
	resolved, source, err := cli.ResolveVFSPath("")
	if err != nil {
		t.Fatalf("cli.ResolveVFSPath: %v", err)
	}
	if resolved != fixture {
...
func TestResolveVFSPathExplicitWins(t *testing.T) {
	...
	resolved, source, err := cli.ResolveVFSPath("/some/explicit/path")
	if err != nil {
		t.Fatalf("cli.ResolveVFSPath: %v", err)
	}
...
func TestResolveVFSPathEnvOverride(t *testing.T) {
	...
	resolved, source, err = cli.ResolveVFSPath("")
	if err != nil {
		t.Fatalf("cli.ResolveVFSPath with env: %v", err)
	}
	if resolved != fixture {
